<?php
if($_POST['cennfrom'] && $_POST['act']=='Skopiuj') $voip->wsdl->MoveCenn($_POST['cennfrom'],$_GET['id'],$_POST['grupa1']);
elseif($_POST['co'] && $_POST['cennchange'] && substr($_POST['act'],0,4)=='Zmie') $voip->wsdl->CennChange($_GET['id'],$_POST['cennchange'],$_POST['co'],$_POST['grupa']);
